            ...
            <div class='card'>
              <div class='card-body'>
                ...
                <div class='d-flex align-items-center justify-content-between w-100'>
                  ...
                  <div class='dropdown'>
                    <button class='btn btn-outline-secondary dropdown-toggle' type='button' id='dateSorter' data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'>This Month</button>
      ...
      <div class='col-md-4'>
        <div class='row'>
          ...
          <div class='col-md-12 grid-margin'>
            <div class='card'>
              <div class='card-body'>
                <h4 class='card-title mb-0'>Top Closers</h4>
...
<script lang='js'>
import statsLineGraph1 from '../components/charts/stats-line-graph-1'
import statsLineGraph2 from '../components/charts/stats-line-graph-2'
import statsLineGraph3 from '../components/charts/stats-line-graph-3'
import statsLineGraph4 from '../components/charts/stats-line-graph-4'
import salesStatisticsOverview from '../components/charts/sales-statistics-overview'
import ticketDistribution from '../components/charts/ticket-distribution'
...
import totalTransaction from '../components/charts/total-transaction'
import realtimeStatistics from '../components/charts/realtime-statistics'
import usersDoughnutChart from '../components/charts/usersDoughnutChart'
